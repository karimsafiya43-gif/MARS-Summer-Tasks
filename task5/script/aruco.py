        ...
        if ids is not None:
            ...
            for i in range(len(ids)):
                ...
                try:
                    ...
                    self.get_logger().info(f'aruco id {ids[i][0]}')
                    self.get_logger().info(f'x={marker_world.pose.position.x:.3f} 'f'y={marker_world.pose.position.y:.3f} 'f'z={marker_world.pose.position.z:.3f}')
