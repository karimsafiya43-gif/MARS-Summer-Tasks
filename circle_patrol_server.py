...
#             prev_x=x
#             prev_y=y
#             arc_len_add=sqrt(dx**2 + dy**2)
#             total_arclength+=arc_len_add
#             begin_dist=sqrt((x-Start_X)**2 + (y-Start_Y)**2)
#             # fback_msg.current_arclength=total_arclength
#             fback_msg.success = False
#             fback_msg.final_report = "moving..."
#             # fback_msg.current_status="moving in circle.."
#             goal_handle.publish_feedback(fback_msg)
#             if moved is False and begin_dist>tolerence:
#                 moved=True
#             if moved is True and begin_dist<tolerence:
#                 velo.linear.x=0.0                    
#                 velo.angular.z=0.0
#                 self.vel.publish(velo)
#                 result.success=True
